...
class _Page1State extends State<Page1> {
  ...
  Widget build(BuildContext context) => NavigatorPageNotify(
        name: 'page1Notify',
        initialParams: widget.params == null ? null : widget.params['page1Notify'],
        onPageNotify: (params) => ThrioLogger.v('flutter1 receive notify:$params'),
        child: Scaffold(
          appBar: PreferredSize(
              preferredSize: Platform.isIOS ? const Size.fromHeight(44) : const Size.fromHeight(56),
              child: AppBar(
          ...
          body: SingleChildScrollView(
            child: Container(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: <Widget>[
                ...
                InkWell(
                  onTap: () {
                    locator<NavigationService>().navigateToView(SplashPage());
                  },
                  child: Container(
                ...
                InkWell(
                  onTap: () => ThrioNavigator.push(
                    ...
                    poppedResult: (params) => ThrioLogger.v('/biz1/flutter1 poppedResult call params:$params'),
                  ),
                  child: Container(
                      padding: const EdgeInsets.all(8),
                      margin: const EdgeInsets.all(8),
