...
class _Page2State extends State<Page2> {
  final _channel = ThrioChannel(channel: 'com.kuroko.demo');
  @override
  void initState() {
    super.initState();
          ...
          body: SingleChildScrollView(
            child: Container(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: <Widget>[
                ...
                InkWell(
                  onTap: () => ThrioNavigator.pop(params: 'popResult /biz2/flutter2'),
                  child: Container(
                      padding: const EdgeInsets.all(8),
                      margin: const EdgeInsets.all(8),
                      color: Colors.yellow,
                ...
                InkWell(
                  onTap: () {
                    ThrioNavigator.notify(url: '/biz1/flutter1', name: 'page1Notify', params: 2);
                  },
                  child: Container(
                      padding: const EdgeInsets.all(8),
                      margin: const EdgeInsets.all(8),
                ...
                InkWell(
                  onTap: () {
                    ThrioNavigator.notify(url: '/biz2/flutter2', name: 'page2Notify');
                  },
                  child: Container(
                      padding: const EdgeInsets.all(8),
                      margin: const EdgeInsets.all(8),
